...
基带信号的码型众多，需要细心地进行梳理，掌握。下面是 Quiz：
...
1. 分别画出 1101001 的双相 Manchester 码、CMI 码、AMI 码的数字基带信号波形，并分析其功率谱三个特性
1. 什么是 AMI 码的连 0 问题？如何解决？
1. 简述 HDB3 码的编码和解码过程
1. 根据 HDB3 码的编码过程，分析HDB3码的功率谱三个特性
1. 多电平码，M=1. 如每个码等概率出现，则每个码能传递几个 bit信息？
1. 100Mbps 的 4 电平码（每个码等概率出现），有效带宽多少？
1. 为什么 CMI 码有效带宽是 2/T？
1. 为什么 AMI 码有效带宽是 1/T？

<br/>

|[Index](./) | [Previous](4-3-baseband) | [Next](4-7-isi)|
