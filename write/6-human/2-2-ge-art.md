...
- 空白（Lacunae）：文本中是否包含一些重要的空白（gap）或缺失（absence），是它故意要暗示的，或它拒绝明确写出来或描绘的？
...
4. 用你研究的作品中的具体示例和证据，支持你的每一个主张（claim）。除了提供合适的引文、总结或描述外，还务必给出你对这些证据的评论，以解释这些引文或细节是如何能够作为您提出的主张的证据的。
